...
@onready var end_level_panel = $CanvasLayer/EndLevelPanel
@onready var victory_label = $CanvasLayer/EndLevelPanel/HBoxContainer/Victory
@onready var defeat_label = $CanvasLayer/EndLevelPanel/HBoxContainer/Defeat
